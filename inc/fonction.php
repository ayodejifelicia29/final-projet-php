<?php
    ...
    //
    // Fonction permettant la création d'un panier(it helps me to prepare for the creation of my panier)
    //
    ...
    //
    // Fonction permettant d'ajouter le produit au panier (to able to add the fonction of the produit)
    //
    function ajouter_produit_panier($id_produit, $quantite, $prix, $titre, $photo, $stock) {

        creation_panier();

        // Le produit est-il déjà dans mon panier?(when the produit is already in my panier)
