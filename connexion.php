...
if ($_POST) {
    ...
    // Si j'ai des données liées au pseudo renseigné dans le formulaire ($r-$reques)
    if ($r->rowCount() > 0) {
...
<div class="col-md-6 border  p-5 my-5 container">
    <form method="post" action="">
        ...
        <div class="form-group text-center" style="background-color:#f1f1f1">
            <button type="submit" style="background-color:#c09167" class="btn btn-dark">Connectez-vous</button>
