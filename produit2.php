...
$r = $pdo->query("SELECT * FROM produit WHERE categorie = 'Oyé Vegan Cosmetics' ");
...
while ($produit = $r->fetch(PDO::FETCH_ASSOC)) {
  ...
  $content .= "<div  class=' container col-md-6 col-lg-3 pl-2 pr-2 pb-5'> 
  <div class=' pt-2 card col-md-15  border border-secondary' style='width: 17rem;'>
            <img style='cursor:pointer' class='shadow p-1 mb-5 bg-body rounded card-img-top' src='$produit[photo]' alt='$produit[titre]' title='$produit[description]'>
                <div class='card-body'>
